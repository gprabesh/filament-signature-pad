...
/*test('signature pad field is instantiated with the correct name', function () {
    expect(\Gprabesh\SignaturePad\Forms\Components\Fields\SignaturePad::make('signature')->getName())->toBe('signature');
});*/

test('can set signature pad stroke minimum width', function () {
    $pad = \Gprabesh\SignaturePad\Forms\Components\Fields\SignaturePad::make('signature');
...
test('can set signature pad stroke maximum width', function () {
    expect(\Gprabesh\SignaturePad\Forms\Components\Fields\SignaturePad::make('signature')
        ->strokeMaxWidth(3.5)
